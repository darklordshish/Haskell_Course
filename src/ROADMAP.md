...
- ✅ `SubjApplied.ipynb` (новый справочник, 16 ячеек, 2 SVG) — апогей триптиха: дело о
  пяти подозреваемых через три мира; Эрлангенская программа; мост Лукасевич ≈ вероятность
